...
const banks = [
  { id: "kb", name: "국민은행", color: "#F9BC00" },
  { id: "shinhan", name: "신한은행", color: "#0046FF" },
  { id: "woori", name: "우리은행", color: "#0066B3" },
  { id: "hana", name: "하나은행", color: "#009B8D" },
  { id: "nh", name: "농협은행", color: "#00A651" },
  { id: "ibk", name: "기업은행", color: "#003DA5" },
];
          ...
          {banks.map((bank) => {
            ...
            return (
              <button
                ...
                className={`relative flex flex-col items-center justify-center h-[100px] rounded-2xl transition-all ${
                  isSelected
              ...
              >
                ...
                <div
                  className="w-12 h-12 rounded-full flex items-center justify-center text-white text-[13px] mb-2"
      ...
      <div className="px-6 pb-8 pt-4">
        <button
          ...
          className={`w-full h-[52px] rounded-xl text-[16px] text-white transition-colors ${
            selected ? "bg-[#00D26A] hover:bg-[#00b85c]" : "bg-[#D1D1D6]"
          }`}
        >
          연결하기
        </button>
